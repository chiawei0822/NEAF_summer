...
#         self.hidden_2 = torch.nn.Linear(10, 8)  # hidden layer
#         self.out = torch.nn.Linear(8, n_output)  # output layer

#     def forward(self, x):
#         x = F.relu(self.hidden_1(x))  #激活函式
#         x = F.relu(self.hidden_2(x))
#         x = self.out(x)
        
#         return x 

# model = Net(n_feature=2, n_output=2) # define the network
# print(model)
import torch
